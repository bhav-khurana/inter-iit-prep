...
class API {
  ...
  static Future<int> getCalorieCount(List<Map> messages, int age, int currWeight, int targetWeight, String expectedTime) async {
    messages.add({
      'role': 'user',
      'content': "I am $age years old. My current weight is $currWeight kg. I want to reach $targetWeight kg in $expectedTime. Give me my expected calorie consumption per day. Reply with ONLY a single integer and NO OTHER TEXT.",
    });
    try {
